...
<div class="row">
	...
	<div class="col-md-6">
		<div class="form-group" id="codbbva-div">
			<label for="codbbva" class="col-md-12 control-label required">Código
				Bbva </label>
			<div class="col-md-12">
				<input type="text" class="form-control" id=codbbva name="codbbva"
					maxlength="200">
		...
		<div class="form-group" id="nrodocumento-div">
			<label for="nrodocumentocou" class="col-md-12 control-label required">Nro.
				documento </label>
			<div class="col-md-12">
				<input type="text" class="form-control" id="nrodocumentocou"
					name="nrodocumentocou" maxlength="11">
				<div class="result"></div>
			</div>
		</div>

		<div class="form-group" id="rznsocial-div">
			<label for="rznsocial" class="col-md-12 control-label required">Razón
				social </label>
			<div class="col-md-12">
	...
	<div class="col-md-6">
		<div class="form-group" id="telfmovil-div">
			<label for="telfmovil" class="col-md-12 control-label required">Teléfono
				móvil </label>
			<div class="col-md-12">
				<input type="text" class="form-control phone-group" id="telfmovil"
					name="telfmovil" maxlength="9">
				<div class="result"></div>
			</div>
		</div>

		<div class="form-group" id="telffijo-div">
			<label for="telffijo" class="col-md-12 control-label required">Teléfono
				fijo </label>
			<div class="col-md-12">
				<input type="text" class="form-control phone-group" id="telffijo"
					name="telffijo" maxlength="9">
				<div class="result"></div>
			</div>
		</div>

		<div class="form-group" id="correo-div">
			<label for="correo" class="col-md-12 control-label required">Correo
				electrónico </label>
			<div class="col-md-12">
...
>>>>>>> refs/remotes/origin/master
	...
	<div class="col-md-12">
		<div class="form-group" id="comentarios-div">
			<label for="observacion" class="col-md-12 control-label">Observación
			</label>
			<div class="col-md-12">
				<textarea class="form-control" id="observacion" name="observacion"
					maxlength="300" wrap="hard"
					style="min-width: 100%; max-width: 100%; min-height: 50px; max-height: 50px;"></textarea>
			</div>
		</div>
	</div>
	<div class="col-md-12">
		<div class="form-group"
			style="margin-bottom: 0px; font-size: 11px; font-style: italic; font-weight: bold;">
			<label for="*" class="col-md-12 control-label"> <span>(<label
					class="required"></label>) Campos obligatorios
			</span>
			</label>
		</div>
	</div>

<div>
			...
			<div class="form-group">
				<div class="boton-siguiente">
					<a data-target="" href="" class="btn btn-primary pull-right"
						data-toggle="modal" onclick="getFormCargarEntregaTarjeta();">Cargar
						Excel</a>  
				</div>
			</div>
		</div>
	...
	<div class="modal fade" id="modalCargaEntregaTarjeta" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	  <div class="modal-dialog">
	    <div class="modal-content"> 
		        <div class="modal-header">
		            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
		            <h3 class="modal-title">Cargar Excel</h3>
		        </div>
		
		        <form id="form-cargar-entrega-tarjeta">
						<div class="form-group form-group-carga">
							<label for=""
								class="col-md-5 control-label carga-content-maxim required">Ubicación Archivo</label>
							<div class="col-md-7 carga-content-maxim">
								<input type="text" id="filename" name="filename"  value="D:/20150615_CargaDiariaEntregas.xlsx"
									class="form-control">
